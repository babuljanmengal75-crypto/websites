...
3. (pre-Pie) Start the Java process with app_process ([see here](https://android.15googlesource.com/platform/frameworks/base/+/oreo-release/cmds/pm/pm))
4. (Pie+) Execute the native program `cmd` ([see here](https://android.15googlesource.com/platform/frameworks/native/+/pie-release/cmds/cmd/))
